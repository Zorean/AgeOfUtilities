...
public class ModArmor {
	...
	public static final ItemArmor.ArmorMaterial ageofutilities_antium_armor = EnumHelper.addArmorMaterial(
			"ageofutilities_antium_armor", Reference.MODID + ":ageofutilities", 25, new int[] { 3, 5, 7, 2 }, 8,
			SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 1.5F);
	...
	public static void init() {
		...
		antium_chestplate = new AntiumArmor("antium_chestplate", ageofutilities_antium_armor, 1,
