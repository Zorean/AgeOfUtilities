...
import com.zorean.ageofutilities.init.tools.*;
...
public class ModTools {
    ...
    public static final Item.ToolMaterial ageofutilities_antium_tools = EnumHelper.addToolMaterial("ageofutilities_antium_tools", 3, 1200, 7.0F, 2.50F, 8);
